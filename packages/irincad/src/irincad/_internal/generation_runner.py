...
from irincad._internal.cli_locking import lock_wait_notice
from irincad._internal.file_metadata import text_to_cad_identity_metadata
from irincad._internal.file_metadata import write_dxf_text_to_cad_metadata
from irincad._internal.source_hash import PythonSourceClosure
from irincad._internal.source_hash import PythonSourceHash
from irincad._internal.source_hash import capture_runtime_closure
from irincad._internal.source_hash import evict_first_party_modules
from irincad._internal.source_hash import python_source_hash
from irincad._internal.source_hash import record_first_party_execution
from irincad._internal.step_scene import LoadedStepScene
from irincad.catalog import render_package_dir
from irincad.cli_logging import CliLogger
from irincad.cli_progress import cli_progress_line
from irincad.coordination import DRAWING_PACKAGE
from irincad.coordination import PHASE_GENERATE
from irincad.coordination import ProgressEvent
from irincad.coordination import STEP_PACKAGE
from irincad.coordination import generator_busy
from irincad.coordination import reporting_as
from irincad.coordination import resolve as resolve_progress
from irincad.coordination.lock import exclusive
from irincad.coordination.paths import write_lock_path
from irincad.render import relative_to_file
from irincad.step_export import build_build123d_step_scene

from irincad._internal.generation_spec import EntrySpec, _display_path
...
def run_script_generator(
    ...
    *,
    ...
    (see :func:`repo_local_loaded_modules`); the running runtime (irincad, the CLI
...
def _run_script_generator_inner(
    ...
    *,
    ...
    if generator_name == "gen_step":
        ...
        from irincad._internal.drawing_package import write_drawing_package
        from irincad.drawing_checks import raise_on_error_findings, validate_drawing_document
...
def _track_spec_generation(
    ...
    *,
    ...
    from "generator busy" -- see :func:`irincad.coordination.generator_busy`.
    """
