...
from irincad._internal.step_scene import SelectorBundle
from irincad._internal.step_scene import SelectorOptions
from irincad._internal.step_scene import adaptive_mesh_resolution_for_scene
from irincad.catalog import CadSource
from irincad.catalog import StepImportOptions
from irincad.catalog import cad_ref_from_dxf_path
from irincad.catalog import cad_ref_from_step_path
from irincad.catalog import find_source_by_path
from irincad.catalog import iter_cad_sources
from irincad.catalog import normalize_cad_ref
from irincad.catalog import normalize_source_ref
...
from irincad.metadata import DEFAULT_MESH_ANGULAR_TOLERANCE
from irincad.metadata import DEFAULT_MESH_TOLERANCE
from irincad.metadata import GeneratorMetadata
from irincad.metadata import resolve_mesh_settings
from irincad.render import relative_to_cwd
...
def _resolve_cli_output_path(
    ...
    *,
    ...
    #
    # The same wording in ``irincad.metadata`` is absolute on purpose and must stay that way:
...
def _warn_if_tolerance_defeats_scale_floor(spec: EntrySpec, adaptive: object) -> None:
    ...
    print(
        f"[irincad] warning: --mesh-tolerance {requested:g} mm is "
