...
from irincad._internal.step_scene_types import ColorRGBA, LoadedStepScene, OccurrenceNode, _identity_transform_matrix
...
# All STEPs in a directory share one __irincad__ directory. Scene caches live under
# ``__irincad__/models/<step-filename>/scene/`` so they sit inside the same per-model
# home as the component-GLB render package (``__irincad__/models/<step-filename>/``)
# and its generation lock, rather than at the __irincad__ root. Each is namespaced by
