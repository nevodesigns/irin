...
def probe(lock_path: Path | str) -> ProbeResult:
    ...
    sentinel under ``__irincad__`` for a model that had never been built, as a side effect
...
def exclusive(
    ...
    *,
    ...
    failure to lock: an unwritable ``__irincad__``, a filesystem without advisory locks, or
