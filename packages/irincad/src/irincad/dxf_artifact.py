...
from irincad.coordination import DRAWING_PACKAGE, PHASE_FINALIZE, artifact_build
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m irincad.dxf_artifact",
...
def build_dxf_artifact(
    *,
    ...
    (the exact dict the CLI prints). Mirrors :func:`irincad.step_artifact_cli.build_step_artifact`
