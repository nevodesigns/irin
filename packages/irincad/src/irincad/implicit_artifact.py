...
The implicit analogue of :mod:`irincad.dxf_artifact`, and the SINGLE producer behind both
...
from irincad.coordination import IMPLICIT_PACKAGE, artifact_build
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m irincad.implicit_artifact",
...
def build_implicit_artifact(
    *,
    ...
    dict the CLI prints). Mirrors :func:`irincad.dxf_artifact.build_dxf_artifact`.
