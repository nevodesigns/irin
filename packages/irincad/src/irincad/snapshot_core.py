...
It lives in irincad rather than in a skill because two skills need it and a skill may not
...
from irincad.coordination import PHASE_RENDER, resolve as resolve_progress
