...
from irincad._internal.cli_locking import (
...
from irincad.coordination import PHASE_GENERATE, STEP_PACKAGE, artifact_build
from irincad.metadata import DEFAULT_MESH_ANGULAR_TOLERANCE, DEFAULT_MESH_TOLERANCE, normalize_mesh_numeric
from irincad.catalog import render_package_dir
from irincad.render import relative_to_cwd
from irincad._internal.step_metadata import read_text_to_cad_step_metadata
from irincad._internal.step_scene import LoadedStepScene, load_step_scene, step_file_hash
from irincad.catalog import iter_cad_sources, source_from_path
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m irincad.step_artifact_cli",
...
def build_step_artifact(
    *,
    ...
    builds — see :func:`irincad.generation.run_script_generator`.
