...
from irincad.metadata import DEFAULT_MESH_ANGULAR_TOLERANCE, DEFAULT_MESH_TOLERANCE
from irincad.catalog import render_package_dir
from irincad._internal.step_scene import LoadedStepScene, load_step_scene_cached
from irincad.step_artifact_cli import infer_entry_kind
...
def _ensure_step_topology_artifact(
    ...
    *,
    ...
    from irincad._internal.component_package import is_assembly_package
...
def _write_topology_sidecar(
    ...
    *,
    ...
    from irincad._internal.component_package import assembly_topology_glb_path, is_assembly_package
...
def _scene_for_regeneration(
    ...
    *,
    ...
    if spec.source == "generated":
        ...
        # generator itself reports through irincad.progress). Without it this call -- which
