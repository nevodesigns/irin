...
from irincad._internal.assembly_spec import find_step_path, resolve_cad_source_path
from irincad.cad_ref_syntax import normalize_cad_path, parse_cad_tokens
from irincad.catalog import find_source_by_cad_ref
...
class EntryTarget:
    ...
    @property
    def token(self) -> str:
        from irincad.cad_ref_syntax import build_cad_token
