...
usage() {
  cat <<'EOF'
Usage:
  scripts/dev/setup-skill-symlink.sh cad [--check]

Sets up CAD skill development symlinks.
...
cd "$REPO_ROOT"
setup_link "$MODE" "skills/cad/scripts/packages/irincad" "../../../../packages/irincad"
