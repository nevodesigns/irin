...
usage() {
  cat <<'EOF'
Usage:
  scripts/dev/setup-skill-symlink.sh dxf [--check]

Sets up DXF skill development symlinks.
...
cd "$REPO_ROOT"
setup_link "$MODE" "skills/dxf/scripts/packages/irincad" "../../../../packages/irincad"
