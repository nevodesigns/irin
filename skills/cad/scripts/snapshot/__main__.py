...
# Warm-daemon shim: must run BEFORE the irincad imports below (which load irincad/OCP at
# module import time). The daemon sets IRINCAD_DAEMON_CHILD so it never recurses; the
