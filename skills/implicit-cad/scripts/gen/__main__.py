...
# Prefer the skill's bundled irincad over any pip-installed copy, exactly like `cad`'s gen
# entry: the vendored scripts/packages/irincad is the version this skill runtime was built
