...
from irincad._internal.step_metadata import (
...
class TextToCadStepMetadataTests(unittest.TestCase):
    def test_injects_and_reads_text_to_cad_metadata(self) -> None:
        with temporary_directory(prefix="cad-step-metadata-") as temp_dir:
            ...
            self.assertIn("PROPERTY_DEFINITION('irincad metadata','irincad:entryKind'", step_text)
    ...
    def test_reads_tail_metadata_without_full_file_scan(self) -> None:
        with temporary_directory(prefix="cad-step-metadata-tail-") as temp_dir:
            ...
            metadata_block = "\n".join(
                [
                    "#100=DESCRIPTIVE_REPRESENTATION_ITEM('irincad:generator','irincad');",
                    "#101=REPRESENTATION('irincad:generator',(#100),#7);",
                    "#102=PROPERTY_DEFINITION('irincad metadata','irincad:generator',#1);",
                    "#103=PROPERTY_DEFINITION_REPRESENTATION(#102,#101);",
                    "#104=DESCRIPTIVE_REPRESENTATION_ITEM('irincad:entryKind','assembly');",
                    "#105=REPRESENTATION('irincad:entryKind',(#104),#7);",
                    "#106=PROPERTY_DEFINITION('irincad metadata','irincad:entryKind',#1);",
                    "#107=PROPERTY_DEFINITION_REPRESENTATION(#106,#105);",
                    "#112=DESCRIPTIVE_REPRESENTATION_ITEM('irincad:sourceHash','source-hash-tail');",
                    "#113=REPRESENTATION('irincad:sourceHash',(#112),#7);",
                    "#114=PROPERTY_DEFINITION('irincad metadata','irincad:sourceHash',#1);",
